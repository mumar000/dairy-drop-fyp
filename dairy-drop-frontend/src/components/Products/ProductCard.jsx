        ...
        <div className='bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 group'>
            ...
            <div className='p-5'>
                ...
                <div className='flex items-center justify-between mb-4'>
                    ...
                    <span className={`text-sm font-semibold ${product.stock > 20 ? 'text-green-600' :
                ...
                <button
                    ...
                    className={`w-full px-4 py-3 font-semibold rounded-lg transition-colors flex items-center justify-center gap-2 ${product.stock > 0
