...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const orderData = { address: addressPayload, fromCart: true };
            ...
            {[
              ...
              <div key={s.num} className="flex items-center flex-1">
                <div className="flex flex-col items-center flex-1">
                  ...
                  <p
                    className={`text-sm font-medium mt-2 ${step >= s.num ? "text-blue-600" : "text-gray-500"}`}
                  >
                    {s.label}
                  </p>
                </div>
                {idx < 2 && (
                  <div
                    className={`h-1 flex-1 mx-2 rounded ${step > s.num ? "bg-blue-600" : "bg-gray-200"}`}
                  />
                )}
              </div>
            ))}
              ...
              <div className="mt-4">
                {paymentMethod === "cod" ? (
                  <div className="p-4 rounded-xl border border-blue-100 bg-blue-50 text-sm text-blue-900">
                    Pay in cash when the order arrives. No online payment
                    needed.
                  </div>
                ) : (
                  <div className="p-4 rounded-xl border border-purple-100 bg-purple-50 text-sm text-purple-900">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-24">
              ...
              <button
                ...
                disabled={isPlacingOrder || isCreatingSession}
